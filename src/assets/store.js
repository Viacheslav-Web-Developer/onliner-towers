...
export const store = {
		...
		prices: {
			cards: [
				...
				},
				{
					...
					addInfo: ['Комплект для установки на лестничный марш +20%']
				},
			],
			ps: '* Минимальный срок аренды - 3 дня.'
		},
		firstTable: {
			title: "Технические характеристики комплектаций вышки туры передвижной",
			tableData: {
				thead: [
	...
	stairs: {
					...
					prices: [
						{
							...
							pricesValue: [
								...
								<p>
									<span>21</span> рублей / 7 дней
								</p>,
								<p>
									<span>90</span> рублей / 30 дней
								</p>,
							],
						},
						{
					...
					prices: [
						...
						},
						{
							...
							pricesValue: [
								...
								<p>
									<span>70</span> рублей / 7 дней
								</p>,
								<p>
									<span>300</span> рублей / 30 дней
								</p>,
							],
						},
						{
		...
		faq: [
			...
			{
				question:
					"Что мне нужно при себе иметь, чтобы взять лестницу в аренду?",
				answer:
					"Чтобы взять лестницу на прокат, вам нужно иметь при себе паспорт для заключения договора и деньги.",
			},
			{
				question:
					"Как быть, когда минимальный срок аренды лестниц, стремянок 3 дня, а мне она нужна на 1 день?",
				answer: "Вы можете привести ее раньше положенного срока сдачи.",
			},
			{
				question: "Можно оплатить по факту?",
			...
			{
				question:
					"Нужно ли оставлять какой-то залог когда мне нужно взять лестницу аренду?",
				answer:
					"Нет. Договор заключается без залоговой стоимость. Можем попросить залог только в том случае, если человек приехал с большим количеством задолженностей по исполнительным документам.",
			},
			{
			...
			{
				question:
					"Какие документы нужно иметь юридическому лицу, чтобы взять строительную лестницу на прокат?",
				answer:
					"Нужно иметь подписанные документы: - договор - счет - акт приема передачи или иметь доверенность.",
			},
		],
